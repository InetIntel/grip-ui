    ...
    return (
        <>
            ...
            <NotionRenderer
                ...
                fullPage={false}
            />
            <iframe src="https://inetintel.notion.site/ebd//1cafd138961080fd9bcad7ffe3dd5a85" width="100%" height="4166px" style={{overflow: "hidden", border: "none"}} frameborder="0" allowfullscreen />
        </>
    );
}
